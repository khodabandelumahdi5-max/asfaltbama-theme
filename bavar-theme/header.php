...
<header class="bv-header" data-bv-header dir="ltr">
	<div class="bv-header__inner">
		...
		<nav class="bv-header__nav" id="bv-nav" aria-label="Main">
			<?php
			wp_nav_menu(
				[
			...
			<div class="bv-header__mobile-actions">
				<a href="<?php echo esc_url( $bavar_account ); ?>">MY BAVAR</a>
			</div>
		</nav>

		<div class="bv-header__actions">
			<a class="bv-header__account" href="<?php echo esc_url( $bavar_account ); ?>">MY BAVAR</a>
			<a class="bv-header__join" href="<?php echo esc_url( home_url( '/#paths' ) ); ?>">JOIN BAVAR</a>
			<button class="bv-header__toggle" type="button" aria-controls="bv-nav" aria-expanded="false" data-bv-toggle>
				<span></span><span></span><span class="screen-reader-text">Menu</span>
			</button>
		</div>
	</div>
</header>
